            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 max-xl:gap-4 gap-6">
              {productsLoading ? (
                ...
                filteredProducts.map((product) => (
                  <div key={product._id} className="bg-white rounded p-4 cursor-pointer hover:-translate-y-1 transition-all relative">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-4">
                        <button type="button" className="text-sm px-2 h-9 font-semibold w-full bg-green-600 hover:bg-green-700 text-white tracking-wide ml-auto outline-none border-none rounded">
