...
export default function Intro() {
    return (
        <section className="py-10 text-white w-screen ">
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-wrap justify-center sm:flex-col md:flex-row md:space-x-6">
    {/* Working Hours */}
    <div className="group w-72 h-40 cursor-pointer flex justify-center sm:mt-[3px]">
    ...
    {/* Call Online */}
    <div className="group w-72 h-40 cursor-pointer flex justify-center rounded-xl border-green-500 sm:mt-[3px]">
        <div className="relative w-full h-full flex items-center justify-center overflow-hidden bg-white p-6 shadow-2xl ring-1 ring-gray-900/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-3xl rounded-lg md:mt-5 lg:mt-0">
            <span className="absolute top-6 left-[1.15rem] z-0 h-12 w-12 rounded-full bg-green-500 transition-all duration-300 group-hover:scale-[15]"></span>
            <div className="relative z-10 flex flex-col space-y-2 w-full">
