...
<div className="relative flex flex-col">
  ...
  <button
    type="button"
    className="bg-blue-600 hover:bg-blue-700 text-white tracking-wide font-semibold text-sm py-3 px-20 rounded-lg w-max mx-auto mt-6 mb-4 transition duration-300 flex justify-center">
    Submit
  </button>
</form>
