          ...
          <div className="flex justify-between">
            ...
            <div className="mt-6">
              <button
                ...
                className="px-5 py-2.5 rounded-lg text-white text-sm tracking-wider font-medium border border-current outline-none bg-green-700 hover:bg-green-800 active:bg-green-700"
              >
                {reviewShow ? "Cancel Reviews" : "Write Reviews"}
              </button>
            </div>
          </div>
          {reviewShow && <FeedBackForm setReviewShow={setReviewShow}  />}
